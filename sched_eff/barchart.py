...
rects1 = ax1.bar(ind, M1, width, color='g', label = 'dynamic', hatch = '/')
rects2 = ax1.bar(ind + 1*width, M2, width, color='r', label = 'fine-grained dynamic', hatch = '-')

# add some text for labels, title and axes ticks
ax1.set_ylabel('speedup against static-distribution', fontsize = 12)
ax1.set_title('QG1')
...
ax1.legend(loc = 'upper left',frameon = True, prop = {'size':12})
...
rects1 = ax2.bar(ind, M1, width, color='g', label = 'dynamic', hatch = '/')
rects2 = ax2.bar(ind + 1*width, M2, width, color='r', label = 'fine-grained dynamic', hatch = '-')
...
ax2.legend(loc = 'upper left',frameon = True, prop = {'size':12})
...
rects1 = ax3.bar(ind, M1, width, color='g', label = 'dynamic', hatch = '/')
rects2 = ax3.bar(ind + 1*width, M2, width, color='r', label = 'fine-grained dynamic', hatch = '-')
...
ax3.legend(loc = 'upper left',frameon = True, prop = {'size':12})

plt.savefig("resdistribution.pdf", dpi = 144);
plt.show()
